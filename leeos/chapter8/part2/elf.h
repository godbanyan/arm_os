...
struct elf32_ehdr{
	unsigned char e_ident[16];			/* 魔数和相关信息 version, code, format */
	elf32_half	e_type;                 /* 目标文件类型  2 stands for exec file*/
	elf32_half	e_machine;              /* 硬件体系  40 stands for arm arch */
...
struct elf32_phdr{
	elf32_word	p_type;				/* 段类型 1 stands for code or data */
